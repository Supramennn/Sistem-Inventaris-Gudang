    ...
    <form action="<?= site_url('barang/store') ?>" method="post">
        ...
        <div class="form-grid">
            <div class="form-group">
                ...
                <input id="kode_barang" type="text" name="kode_barang" value="<?= esc(old('kode_barang', $kode)) ?>" readonly>
            </div>
            ...
            <div class="form-group">
                ...
                <input id="harga" type="number" name="harga" min="0" step="0.01" value="<?= esc(old('harga', 0)) ?>">
            </div>
        </div>
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input id="stok_minimum" type="number" name="stok_minimum" min="0" value="<?= esc(old('stok_minimum', 10)) ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <select id="satuan_id" name="satuan_id" required>
                    ...
                    <?php foreach ($satuan as $item): ?>
                        <option value="<?= esc($item['id']) ?>" <?= old('satuan_id') == $item['id'] ? 'selected' : '' ?>>
            ...
            <div class="form-group">
                ...
                <select id="kategori_id" name="kategori_id" required>
                    ...
                    <?php foreach ($kategori as $item): ?>
                        <option value="<?= esc($item['id']) ?>" <?= old('kategori_id') == $item['id'] ? 'selected' : '' ?>>
            ...
            <div class="form-group">
                ...
                <select id="supplier_id" name="supplier_id" required>
                    ...
                    <?php foreach ($supplier as $item): ?>
                        <option value="<?= esc($item['id']) ?>" <?= old('supplier_id') == $item['id'] ? 'selected' : '' ?>>
            ...
            <div class="form-group">
                ...
                <select id="gudang_id" name="gudang_id" required>
                    ...
                    <?php foreach ($gudang as $item): ?>
                        <option value="<?= esc($item['id']) ?>" <?= old('gudang_id') == $item['id'] ? 'selected' : '' ?>>
        ...
        <div class="form-group">
            ...
            <textarea id="deskripsi" name="deskripsi" rows="3"><?= esc(old('deskripsi')) ?></textarea>
        </div>
